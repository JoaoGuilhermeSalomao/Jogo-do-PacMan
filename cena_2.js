var SceneTwo = new Phaser.Class({
    ...
    preload: function() {
        ...
        this.load.image('fundo_1', 'assets/cena_1.jpg');
        this.load.image('chao_1', 'assets/cena_1_baixo.jpg');
    ...
    create: function() {
        // imagem de fundo
        this.add.image(626, 417, 'fundo_1').setScale(0.25);
        ...
        pacMan = this.physics.add.sprite(554, 715, 'pac').setScale(2);
        ...
        chao = this.physics.add.staticImage(626, 950, 'chao_1').setScale(0.25);
        ...
        // passarinho verde
        green = this.physics.add.sprite(100, 550, 'green').setScale(1.6);
        ...
        // passarinho vermelho
        red = this.physics.add.sprite(1152, 700, 'red').setScale(1.6);
    ...
    update: function() {
        ...
        if (teclado.up.isDown && pacMan.y === 715 && vida > 0){
        ...
        if (green.x < 1152 && green.ida === true) {
            green.x +=2;
        } 
        ...
        // pontuação maxima e proxima fase
        if (pontuacao >= 10) {
